...
hold on
b = plot(hydro_nse(hydro_idxb_rsa),hydro_pbias(hydro_idxb_rsa),'ok','MarkerSize',4,'MarkerFaceColor','k');
% Threshold
...
for i = 1:M
    b = bar(i,hydro_mvd(i));
    hold on
    set(b,'FaceColor',1-[1 1 1]*hydro_mvd(i))
end
for i = 1:E
    b = bar(M+i,erosion_mvd(i));
    hold on
    set(b,'FaceColor',1-[1 1 1]*erosion_mvd(i))
end
...
for i = 1:ME
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*rand_erosion_mvd(i))
end
ylabel('mvd','FontSize',fs)
axis([0,ME+1,0,1])
% plot([M M]+0.5,[-0.5 1.5],'--k')
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*hydro_genpawn_max_Tm(i))
end
for i = 1:E
    b = bar(M+i,erosion_genpawn_max_Tm(i));
    hold on
    set(b,'FaceColor',1-[1 1 1]*erosion_genpawn_max_Tm(i))
end
...
for i = 1:ME
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*rand_erosion_genpawn_max_Tm(i))
end
ylabel('pawn','FontSize',fs)
axis([0,ME+1,0,1])
...
disp(' ')
%% 54. BAR PLOT OF SENSITIVITY INDICES (PAWN GEN SAMPL) FOR MODEL OUTPUTS
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*hydro_genpawn_maxQ_max_Tm(i))
end
ylabel('pawn','FontSize',fs)
axis([0,M+.6,0,1])
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*hydro_genpawn_meanQ_max_Tm(i))
end
ylabel('pawn','FontSize',fs)
axis([0,M+.6,0,1])
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*hydro_genpawn_minQ_max_Tm(i))
end
ylabel('pawn','FontSize',fs)
axis([0,M+.6,0,1])
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*rand_erosion_genpawn_maxC_max_Tm(i))
end
for i = M+1:ME
...
for i = 1:M
    ...
    hold on
    set(b,'FaceColor',1-[1 1 1]*rand_erosion_genpawn_meanC_max_Tm(i))
end
for i = M+1:ME
